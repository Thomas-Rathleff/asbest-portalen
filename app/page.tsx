    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#1a365d] via-[#2a4a7f] to-[#1a365d] text-white py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Stats — over søgning så udvidede resultater ikke overlapper med senere søskende i stacking */}
          <div className="mt-4 mb-10 grid grid-cols-3 gap-8 max-w-lg mx-auto">
            <div>
          ...
          {/* Søgefelt med live adresseopslag — z-10 så resultatkort ligger over statistikken ved overlap */}
